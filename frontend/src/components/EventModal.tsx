...
import { Modal, Form, Input, DatePicker, Switch, Select, InputNumber, message } from 'antd';
...
export const EventModal: React.FC<EventModalProps> = ({ open, event, defaultDate, onClose, onSaved }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item name="reminder_minutes_before" label="Reminder (minutes before)">
